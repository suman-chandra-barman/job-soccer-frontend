...
export function TechnicalDirectorVideoForm({
  onNext,
  onPrev,
  initialData,
  steps,
  ...
  const [videoMap, setVideoMap] = useState<IVideoMap>(() => {
    ...
    if (initialData?.videos && initialData.videos.length > 0) {
      return {
        ...
        [VideoType.CLUB_PHILOSOPHY_METHODOLOGY]: initialData.videos[1] || null,
        [VideoType.PLAYER_RECRUITMENT_METHODOLOGY]:
          initialData.videos[2] || null,
      };
    }
    return {
      [VideoType.PRE_RECORDED_INTERVIEW]: null,
      [VideoType.CLUB_PHILOSOPHY_METHODOLOGY]: null,
      [VideoType.PLAYER_RECRUITMENT_METHODOLOGY]: null,
    };
  });
  ...
  const hasAllRequiredVideos =
    ...
    videoMap[VideoType.CLUB_PHILOSOPHY_METHODOLOGY] !== null &&
    videoMap[VideoType.PLAYER_RECRUITMENT_METHODOLOGY] !== null;
        ...
        <div className="space-y-6">
          ...
          <IndividualVideoUpload
            ...
            error={
              hasSubmitted &&
              errors.videos &&
              !videoMap[VideoType.CLUB_PHILOSOPHY_METHODOLOGY]
                ? "This video is required"
                : undefined
            }
          />
          ...
          <IndividualVideoUpload
            ...
            error={
              hasSubmitted &&
              errors.videos &&
              !videoMap[VideoType.PLAYER_RECRUITMENT_METHODOLOGY]
                ? "This video is required"
                : undefined
            }
          />
