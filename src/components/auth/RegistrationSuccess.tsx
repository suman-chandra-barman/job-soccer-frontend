...
export default function RegistrationSuccess({ userName = "User", onNext }: RegistrationSuccessProps) {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-xl w-full text-center">
        ...
        <div className="mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Welcome to Jobsoccer</h2>
          <p className="text-gray-600 text-sm leading-relaxed">
            Your information has been successfully saved. We&apos;re currently upgrading our football job platform. Please
            bear with us as we work to ensure it delivers precise opportunities for our users.
          </p>
        </div>
